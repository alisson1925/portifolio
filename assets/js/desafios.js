function desafios(section) {
  section.innerHTML = 
    `<header>
      ...
      <a
        href="https://github.com/alisson1925"
        target="_blank"
      >
        <svg
      ...
      <div class="cards">
        <div class="card">
          ...
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/desafios/1.png"
            ...
            <div class="buttons">
              ...
              <a href="https://github.com/alisson1925" 
              target="_blank"
              title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <p>
            Criar um repositório no Github para por os 21 desafios de cada dia.
          </p>
        </div>
        <div class="card">
          <h3>Desafio 2</h3>
          ...
          <p>Fazer um Hello World costumizado com fonte, cor e imagens.</p>
          <p>HTML - CSS</p>
        </div>
        <div class="card">
          <h3>Desafio 3</h3>
        ...
        <div class="card">
          ...
          <div class="img-wrapper">
            ...
            <div class="buttons">
              <a href="https://github.com/alisson1925" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://github.com/alisson1925" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
        ...
        <div class="card">
          ...
          <p>
            Desenvolver um site que exiba uma vitrine de produtos de um e-commerce fictício (com nome dos produtos, preços e imagens).
          </p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
          ...
          <p>
            Desenvolver um site utilizando alguma API pública.
          </p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
          ...
          <p>
            Desenvolver um site que capture os eventos do teclado e exiba na tela o evento e a tecla pressionada.
          </p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
          ...
          <p>
            Desenvolver um gerador de senhas aleatórias.
          </p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
          ...
          <p>
            Desenvolver um site que gere imagens aleatórias utilizando a API do Unsplash.
          </p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
          ...
          <p>
            Desenvolver um site de emoji picker.
          </p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
          ...
          <div class="img-wrapper">
            ...
            <div class="buttons">
              ...
              <a href="file:///C:/Users/M%C3%BCller/Documents/Projeto%20Clonados/portifolio/index.html" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
